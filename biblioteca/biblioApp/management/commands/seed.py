...
def create_books(num_books=20):
    ...
    for _ in range(num_books):
        ...
        Book.objects.create(author=author, edition_date=edition_date, CDU=CDU, ISBN=ISBN, publisher=publisher, colection=collection, pages=pages)
...
def create_cds(num_cds=20):
    ...
    for _ in range(num_cds):
        ...
        CD.objects.create(author=author, edition_date=edition_date, discography=discography, style=style, duration=duration)
...
def create_dispositives(num_dispositives=10):
    ...
    for _ in range(num_dispositives):
        ...
        Dispositive.objects.create(brand=brand, dispo_type=dispo_type)
